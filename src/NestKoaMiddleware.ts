...
export const koaToNestMiddleware = (middleware: Koa.Middleware): NestKoaFunctionalMiddleware => (req: Koa.Request, res: Koa.Response, next: Koa.Next) => middleware(req.ctx, next);
