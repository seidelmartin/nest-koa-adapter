...
import { koaToNestMiddleware, NestKoaFunctionalMiddleware, NestKoaMiddleware } from '../src/NestKoaMiddleware';
...
const scopedMiddleware: NestKoaFunctionalMiddleware = (req, res, next) => res.body = SCOPED_VALUE;
...
const globalMiddleware: NestKoaFunctionalMiddleware = (req, res, next) => res.body = GLOBAL_VALUE;

const convertedMiddleware: NestKoaFunctionalMiddleware = koaToNestMiddleware((ctx, next) => ctx.body = CONVERTED_VALUE);
